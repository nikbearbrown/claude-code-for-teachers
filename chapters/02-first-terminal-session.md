...
<!-- → [DIAGRAM: The agentic loop. Three-phase cycle: Gather context → Take action → Verify results → [repeat]. Human interruption point marked at each phase (Esc, plan mode, handoff condition check). Editorial style. No color.] -->
